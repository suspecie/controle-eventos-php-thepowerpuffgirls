...
class tipoacessoModel extends model {
    ...
    public function estrutura_vazia() {
        $dados = null;
        $dados[0]['codigo'] = NULL;
        $dados[0]['acessodescricao'] = NULL;    
        return $dados;
    }

    
    /** Retrieve the Entity */
    public function getTipoacesso($where = null) {
        $select = array('*');
        return $this->read($this->tabPadrao, $select, $where, null, null, null, null);
    }

    /** Save a new Entity  */
    public function setTipoacesso($array) {
    ...
    /** Update the Entity */
    public function updTipoacesso($array) {
        //Chave    
     ...
     /** Remove the Entity */
    public function delTipoacesso($array) {
        //Key 
        $where = $this->campo_chave . " = " . $array[$this->campo_chave];        
        $this->startTransaction();
