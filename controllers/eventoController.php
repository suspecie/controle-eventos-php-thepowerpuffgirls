...
class evento extends controller {
    ...
    public function mostraGrid() {
        ...
        $qry_limitada = $model->readSQL("SELECT"
                ...
                . " FROM evento e "
                . " LEFT JOIN cidade c ON (c.codigo = e.id_cidade)"
                . " LEFT JOIN status_evento se ON (se.codigo = e.id_status)"
                . " LIMIT $inicio,$total_reg");
        
        
        $this->smarty->assign('listevento', $qry_limitada);
        // Total de Registros na tabela    
        $qry_total = $model->readSQL("SELECT count(*)as total FROM evento");
