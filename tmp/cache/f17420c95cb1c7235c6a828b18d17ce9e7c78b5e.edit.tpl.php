...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_56c5b5e7d94959_81584018',
  'file_dependency' => 
  array (
...
function content_56c5b5e7d94959_81584018 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <form role="form" action="/operadorescomsenha/update/id/20" method="POST" enctype="multipart/form-data">
                                <input type="hidden" class="form-control" id="id" name="id" value="20">

                                <div class="form-group">
                                   <label for="nome">Nome</label>
                                    <input required="true" type="input" class="form-control" id="nome" name="nome" value="99999">
                               
                                     <label for="senha">Senha</label>
                                    <input required="true" type="password" class="form-control" id="senha" name="senha" value="99992222">
