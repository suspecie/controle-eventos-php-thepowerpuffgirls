...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_56c4bb0cf0d757_40580093',
  'file_dependency' => 
  array (
...
function content_56c4bb0cf0d757_40580093 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <form role="form" action="/cliente/update/id/13" method="POST" enctype="multipart/form-data">
                                <input type="hidden" class="form-control" id="id" name="id" value="13">

                                <div class="form-group">
                                    <label for="nome">Nome</label>
                                    <input required="true" type="input" class="form-control" id="nome" name="nome" value="f">
                                    
                                    <label for="endereco">Endereço</label>
                                    <input required="true" type="input" class="form-control" id="endereco" name="endereco" value="f">
                                    
                                    
                                    <label for="codigo_uc">Código UC</label>
                                    <input required="true" type="input" class="form-control" id="codigo_nis" name="codigo_uc" value="0">
                                    
                                    <label for="codigo_nis">Código NIS</label>
                                    <input required="true" type="input" class="form-control" id="codigo_uc" name="codigo_nis" value="0">
                               
                                    <label for="cpf">CPF</label>
                                    <input required="true" type="input" class="form-control" id="cpf" name="cpf" value="0">
                                   
                                    <label for="rg">RG</label>
                                    <input required="true" type="input" class="form-control" id="rg" name="rg" value="f">
                                </div>  
